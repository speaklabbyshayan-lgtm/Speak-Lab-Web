...
hero_new = """<div class="hero-cta-wrapper">
        ...
        <a href="https://wa.me/923204307432" class="hero-btn secondary-btn" target="_blank">
...
new_faqs_html = """
        ...
        <div style="text-align: center; margin-top: 30px;">
          <a href="https://wa.me/923204307432" target="_blank" class="faq-see-all">STILL HAVE QUESTIONS? CHAT WITH US &rarr;</a>
        </div>
"""
    ...
    <div class="ai-premium-card" style="background: #111;">
      <div class="ai-card-content">
        ...
        <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
          ...
          <a href="https://wa.me/923204307432" class="btn-outline" style="border-color: #333; color: #fff;" target="_blank">ASK US ANYTHING ON WHATSAPP</a>
        </div>
        <p style="margin-top: 25px; font-size: 0.85rem; color: #666; font-weight: 600;">📧 info@speaklabbyshayan.com | 📱 +92 320 4307432</p>
      </div>
    </div>
  </section>
"""
