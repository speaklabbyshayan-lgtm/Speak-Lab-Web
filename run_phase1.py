...
for filename in os.listdir(directory):
    if filename.endswith(".html"):
        ...
        # PHASE 1:
        # 1. WhatsApp number
        content = re.sub(r'https://wa\.me/(?!\d)', 'https://wa.me/923204307432', content)
        content = content.replace("Number coming soon", "+92 320 4307432")
        ...
        # DOWNLOAD SYLLABUS button -> https://wa.me/923204307432
        content = re.sub(r'href="[^"]*"([^>]*>\s*DOWNLOAD SYLLABUS)', r'href="https://wa.me/923204307432"\1', content, flags=re.IGNORECASE)
        content = re.sub(r'href=\'#\'([^>]*>\s*DOWNLOAD SYLLABUS)', r'href="https://wa.me/923204307432"\1', content, flags=re.IGNORECASE)

        # 4. Fix footer newsletter button
        content = re.sub(r'<button type="button">ENROLL</button>', r'<button type="button" onclick="window.open(\'https://wa.me/923204307432\', \'_blank\')">GET EARLY ACCESS</button>', content)
